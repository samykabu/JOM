...
namespace MapMenu.Studies
{
    ...
    /// </summary>
    public partial class GeneralStudies
    {
        ...
        private void RefreshButtons()
        {
            ...
            var Categories = from category in App.ActiveDatabase.DatabaseEntities.Category
                             where category.Sections.SectionID == Util.GeneralStudies
                             select category;
        ...
        {
            DataUpload de = new DataUpload(Util.ApplicationRoot, true, null, Util.GeneralStudies,
